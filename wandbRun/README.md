...
This directory was generated from the report named [Recognize the number from 0 to 9 using CNN](https://wandb.ai/alexandria-university_foe/digit-speech-recognition/reports/Recognize-the-number-from-0-to-9-using-CNN--Vmlldzo4MDA5OTAy).
